...
namespace PatientPanel.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return Redirect("http://localhost:9509/");
                    }
                    else if (roles.Result.Contains("Doctor"))
                    {
                        return Redirect("http://localhost:28137/");
                    }
